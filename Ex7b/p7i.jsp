...
String JDBC_DRIVER = "com.mysql.jdbc.Driver";
    ...
    String marvel = "Database Result [ JSP ]";
...
try {
    ...
    PreparedStatement ps = conn.prepareStatement("UPDATE shows set comment=? where Title=?");
    ...
    out1.println("<script>function R() {location.replace('http://localhost:8080/ex72/p7.jsp')}</script>");
